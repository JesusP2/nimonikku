/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 2b317282bcb84c8109496eac2ee53f2a)
...
declare namespace Cloudflare {
	interface Env {
		...
		ADMIN_SECRET: string;
		Pikaboard: DurableObjectNamespace<import("./src/index").Pikaboard>;
		DB: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CORS_ORIGIN" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "ADMIN_SECRET">> {}
}
