/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: f744246e202b14a83ccaead9490ce427)
...
declare namespace Cloudflare {
	interface Env {
		...
		ADMIN_SECRET: string;
		Pikaboard: DurableObjectNamespace<import("./src/server/index").Pikaboard>;
		DB: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "VITE_SERVER_URL" | "ADMIN_SECRET">> {}
}
